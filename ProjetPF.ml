...
let comparer : string -> string -> int = 
  fun mot1 mot2 ->
    let rec aux  = fun mot1 mot2 nb_carac_identique ->
      ...
      if (String.sub mot1 0 1  ) = (String.sub mot2 0 1  ) then aux (String.sub mot1 1 (taille-1)) (String.sub mot2 1 (taille-1)) nb_carac_identique+1
      else aux (String.sub mot1 1 (taille-1)) (String.sub mot2 1 (taille-1)) nb_carac_identique
    in aux mot1 mot2 0
;;     
...
let deviner : string->string=
  fun mot_mystere -> 
    ...
    List.nth (Mystere.evolution evaluateur t t (t/2) t) 0
;; 
